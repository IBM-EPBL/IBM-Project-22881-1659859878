...
elif distance < 60 and distance > 41: dist = 'Risk warning:' '40 %'
else:
...
warn = 'alert :' ' Dumpster poundage getting high, Time to collect :)' elif load == "60 %" or distance == "60 %":
...
print("published distance = %s " %distance,"loadcell:%s " %loadcell,"lon = %s " %long,"lat = %s" %lat) print(load)
...
if not success:
print("not connected to ibmiot") time.sleep(30)
